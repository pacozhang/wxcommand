...
public class MayDayCouponsvr extends SvrProcess {
...
/*		try{
			...
			event.setParameter("command", "nds.weixinpublicparty.ext.MayDayCommand");
			vh= controller.handleEvent(event);
		}catch(Exception e){
			log.debug("call nds.weixinpublicparty.ext.MayDayCommand error->"+e.getLocalizedMessage());
			e.printStackTrace();
		}*/
		return null;
	}
