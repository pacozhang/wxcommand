...
/*		try{
			...
			event.setParameter("command", "nds.weixinpublicparty.ext.SinglesDayCommand");
			vh= controller.handleEvent(event);
		}catch(Exception e){
			log.debug("call nds.weixinpublicparty.ext.SinglesDayCommand error->"+e.getLocalizedMessage());
			e.printStackTrace();
		}*/
		return null;
	}
