...
public class TwelveDayCouponsvr extends SvrProcess {
...
/*		try{
			...
			event.setParameter("command", "nds.weixinpublicparty.ext.TwelveDayCommand");
			vh= controller.handleEvent(event);
		}catch(Exception e){
			log.debug("call nds.weixinpublicparty.ext.TwelveDayCommand error->"+e.getLocalizedMessage());
			e.printStackTrace();
		}*/
		return null;
	}
