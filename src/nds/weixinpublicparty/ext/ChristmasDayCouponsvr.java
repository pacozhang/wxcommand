...
public class ChristmasDayCouponsvr extends SvrProcess {
...
/*		try{
			...
			event.setParameter("command", "nds.weixinpublicparty.ext.ChristmasDayCommand");
			vh= controller.handleEvent(event);
		}catch(Exception e){
			log.debug("call nds.weixinpublicparty.ext.ChristmasDayCommand error->"+e.getLocalizedMessage());
			e.printStackTrace();
		}*/
		return null;
	}
