...
public class ValentinesDayCouponsvr extends SvrProcess {
...
/*		try{
			...
			event.setParameter("command", "nds.weixinpublicparty.ext.ValentinesDayCommand");
			vh= controller.handleEvent(event);
		}catch(Exception e){
			log.debug("call nds.weixinpublicparty.ext.ValentinesDayCommand error->"+e.getLocalizedMessage());
			e.printStackTrace();
		}*/
		return null;
	}
